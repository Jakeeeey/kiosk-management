...
export function ProductionAttendanceModule({ url }: ProductionAttendanceModuleProps) {
    ...
    const handleRefresh = () => {
        setIsLoading(true);
        const iframe = document.getElementById("production-attendance-iframe") as HTMLIFrameElement;
        if (iframe) {
