...
interface VitalAttendanceModuleProps {
    url?: string;
}

export function VitalAttendanceModule({ url }: VitalAttendanceModuleProps) {
    ...
    const handleRefresh = () => {
        setIsLoading(true);
        const iframe = document.getElementById("vital-attendance-iframe") as HTMLIFrameElement;
        if (iframe) {
