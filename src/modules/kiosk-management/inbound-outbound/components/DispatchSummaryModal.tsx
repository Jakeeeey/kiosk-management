...
export function DispatchSummaryModal({
    ...
    const fetchData = React.useCallback(async () => {
        ...
        try {
            ...
            const invoicesRes = await fetch(`/api/kiosk-management/inbound-outbound?plan_id=${plan.id}`);
            ...
            const salesInvoicesRes = await fetch(`/api/kiosk-management/inbound-outbound?action=sales-invoices`, {
                method: 'POST',
            ...
            const customersRes = await fetch(`/api/kiosk-management/inbound-outbound?action=customers`, {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
