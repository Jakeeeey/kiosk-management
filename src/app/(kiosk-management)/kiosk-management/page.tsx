                    ...
                    {KIOSK_FEATURES.map((feature) => {
                        const CardComponent = (
                            <Card className={cn(kioskCardVariants(), feature.bgClass, "text-white ring-1 ring-white/10")}>
                                ...
                                {/* Bottom segment wrapped in a flex-container */}
                                <CardContent className="relative z-10 flex flex-1 w-full flex-col items-center justify-start gap-4 px-6 pb-8 mt-2 md:mt-4">
                                    {/* Description (min height ensures it takes up equal space regardless of 1 or 2 lines) */}
                            ...
                            return (
                                <Dialog key={feature.title}>
                                    <DialogTrigger asChild>
                                        <div className="w-full max-w-sm cursor-pointer outline-none tap-highlight-transparent border-none">
                                            {CardComponent}
                                        </div>
                                    </DialogTrigger>
                                    <DialogContent className="sm:max-w-md bg-background/95 backdrop-blur-3xl shadow-2xl overflow-hidden pt-8 pb-10 gap-6">
                                        ...
                                        <DialogHeader className="flex flex-col items-center gap-2 pt-2 pb-0">
                                            <div className="flex h-20 w-20 shrink-0 items-center justify-center rounded-3xl bg-primary/10 shadow-inner dark:bg-primary/20 text-primary mb-2 ring-1 ring-primary/20">
                                        ...
                                        <div className="flex flex-col items-center gap-4 px-4 w-full">
                                            ...
                                            <div className="relative w-full max-w-[280px]">
                                                ...
                                                <Input
                                                    ...
                                                    className="pl-12 text-center h-14 bg-muted/60 hover:bg-muted/80 border-dashed border-2 font-mono text-lg rounded-xl focus-visible:ring-primary shadow-inner transition-colors duration-200"
                                                    readOnly
                                                />
                                            </div>
